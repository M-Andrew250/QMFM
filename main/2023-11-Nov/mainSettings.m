...
opts.roundId        = "2023 Nov Forecast";
opts.modelFile      = "minecofin";
opts.mainDataFile   = "2023-11-11";
opts.addDataFile    = "2023-11-11";
opts.compRound      = "main/2023-07-July";
%% Name of the parameters; 

%opts.parameterNames   = "setparam_fiscImp";
%opts.parameterLegends = "Orig";

opts.parameterNames   = "setparam_fiscImp"; %["setparam";  "setparam_fiscImp"];
opts.parameterLegends = "Orginal"; %["Normal.";     "Higher fiscImp"];
...
% Filtered range
opts.filterHistory.range = qq(2006,1) : qq(2023,2); % default 2023Q2 if data; extend filter for shocktuning +2Q
...
% Table range
opts.filterHistory.rangeTable = qq(2019,1) : qq(2023,2); % default 2023Q2; extend filter for shocktuning, +2Q

% Plot range
opts.filterHistory.rangePlot = qq(2015,1) : qq(2023,2); % same
...
opts.histForecast.range = qq(2016,1) : qq(2023,3);
...
% Horizon of forecast
opts.forecast.range = qq(2023,3) : qq(2027,4); % extended forward each Q if new data
...
opts.forecastReport.plotRange = qq(2017,1) : qq(2027,4); % extended 2026Q4

% Range of the highlighted area i.e. highlight recent past
opts.forecastReport.highlightRange = qq(2015,1) : qq(2023,2); %  

% Range of the tables in the forecast report
opts.forecastReport.tableRange = qq(2022,1) : qq(2025,2); % extend 2025Q2

% Range for annualized series
opts.forecastReport.tableRange_ann = yy(2021) : yy(2027);
