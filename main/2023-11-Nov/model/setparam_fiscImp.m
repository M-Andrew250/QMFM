...
p.a5_cons   = 0.25; 0.1; 0.25; 0.5; % Fiscal impulse; coeff=impact/cons share GDP=0.4/0.78=0.5
...
p.a5_inv   = 0.15; 0.06; 0.15; 0.3; % Fiscal impulse; coeff=impact/cons share GDP=0.04/0.13=0.3;
% divide by 2 as fiscal impulse eq. has factor 2: ie sum discr + ch struct def
