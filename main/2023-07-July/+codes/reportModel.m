...
if opts.reportModel.IRF.run
  ...
  codes.writeMessage(mfilename + ": adding impulse responses ...");
  ...
  if prod(optsIRF.subplot) < numel(xnames)
...
if opts.reportModel.varDecomp.run
  ...
  codes.writeMessage(mfilename + ": adding variance decompositions ...");
...
if opts.reportModel.equations.run
  ...
  codes.writeMessage(mfilename + ": adding equations ...");
...
codes.writeMessage(mfilename + ": compiling ...");
