...
% db.ndef_lcy = db.ndebt_lcy - db.ndebt_lcy{-1}; % def-fin cant be calc fr chDebt
...
% and level of grants; not all s.a. saved in dbAux
...
% deficit financing fr Fiscal data, ratios to GDP, then s.a.
%dbAux.def_lcy_y = db.def_lcy_y_sa; % used in model,sa as def_y is sa
