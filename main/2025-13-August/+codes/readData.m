...
db.cons(qq(2023, 3) : qq(2024,  4))   = NaN;
db.inv(qq(2023,  3) : qq(2024,  4))   = NaN;
db.exp(qq(2023,  3) : qq(2024,  4))   = NaN;
db.imp(qq(2023,  3) : qq(2024,  4))   = NaN;
db.gdem(qq(2023, 3) : qq(2024,  4))   = NaN;
% EvM approach
...
codes.utils.writeMessage(mfilename + ": saving .mat file to CSV ...");
codes.utils.saveCsv(opts, "ObsData", dbObs);
disp([mfilename ': saving results ...completed']);
codes.utils.writeMessage(mfilename + ": done");
