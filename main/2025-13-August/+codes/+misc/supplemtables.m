...
dc.checkNAnom = dc.cons_y_nom_a + dc.gdem_y_nom_a + dc.inv_y_nom_a + dc.exp_y_nom_a - dc.imp_y_nom_a - 100;
...
%   "d4l_imp_a",   "Real imports % growth p.y."
  ...
  "gdem_y_a",             "Govt demand G&S, % of real GDP"  
...
%   "d4l_z_pa",   "Real exchange, rate % change period average"
  ...
  "cons_y_a"          "..Real private consumption, % of real GDP"
  "inv_y_a"           "..Real private investment, % of real GDP"
  "gdem_y_a"          "..Real govt demand G&S, % of real GDP" 
  "exp_y_a"           "..Real exports G&S, % of real GDP" 
  "imp_y_a"           "..Real imports G&S, % of real GDP" 
  "checkNAreal"         "........check NAreal"
...
codes.utils.saveReport(opts, "TableAnnualGrowth", rprt);
...
dc_select = databank.retrieve(dc,["pct4_y_a","dl_py_pa","pct4_cpi_eop","pct4_cpi_pa","pct4_cons_a", "pct4_cons_a", "pct4_inv_a", "pct4_gdem_a", "pct4_exp_a", "pct4_imp_a",...
    "def_a","grev_a", "gdem_y_a","oexp_a", "grants_y","def_inc_grants_a",...
