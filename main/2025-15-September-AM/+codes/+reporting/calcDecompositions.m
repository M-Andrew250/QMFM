...
% codes.reporting.calcDecompositions calculates equation decompositions.
%
% Usage: dc = codes.reporting.calcDecompositions(m, db, checkRange)
%
% Inputs:
% - m:            the model object, possibly with multiple
%                 parametrizations
% - db:           the database fr omwhere the series are taken; it must
%                 have as many columns as there are parametrizations
% - checkRange:   the on range on which the validity of the decompositions
%                 is checked
%
% Outputs:
% - dc: the database of the contributions.
%
% See also: codes.reportFilter, codes.reportForecast,
% codes.reporting.addDecompCharts, codes.reporting.addDecompTables
...
seriesName    = "def_y";
legendEntries = ["Govt. Demand", "Other expenditures", "Revenues"];
