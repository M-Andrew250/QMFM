...
if opts.reportCompareData.run
  codes.reportCompareData()
end

%% Report forecast comparison

if opts.reportCompareForecast.run
  codes.reportCompareForecast()
end

%% Report forecast change decomposition

if opts.reportForecastChangeDecomp.run
