...
rngAdj1 = qq(2022, 1) : qq(2023,4); % 0.75 corr fr 2022 pending NA corr
...
dbObs.obs_rstar_tnd    = hpf2(100*log(1+db.rstar_US_cbo/100)); % this is new rstar_tnd from CBO (in addData...)
