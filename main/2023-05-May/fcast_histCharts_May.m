...
food_decomp = dbDecomp.dl_cpi_food;
figure ();
barcon(plotRange,food_decomp.decompContribs{1}, ...
  'colormap', parula);
hold on
plot(plotRange,food_decomp.decompSeries{1}, ...  
  'color',    'w');
plot(plotRange,food_decomp.decompSeries{1}, ...
  'linewidth', 1, ...
  'color',    'k');
grid on
legend(food_decomp.legendEntries, ...
  'location', 'southoutside', ...
  'orientation', 'horizontal');
highlight(HighRange);
title(food_decomp.figureName, 'FontSize',12,...
    'interpreter', 'none');
exportgraphics(gcf, 'graphs/cpi_food_decomp.emf');
%=========================================================================================================================================================================================================================
%% Exchange rate
...
'linewidth', 2); %...
%'color', 'r'),...
legend ('ER, ann. QQ %', 'ER tar, ann. QQ %', 'interpreter', 'none','Fontsize',10);
zeroline
grid on
highlight(HighRange) %,'EdgeColor','m','LineWidth',1.5);
title('Nominal exchange rate: Actual vs. Target, ann. QQ %', 'FontSize',12); %,'interpreter', 'none');
...
plot(plotRange, dbFcast.dl_z, 'linewidth', 1, 'color', 'k');
...
%% RER (real exchange rate) growth and trend
% RER (l_z_gap) goes to final dem thru rmci_cons, rmci_inv, rmci_exp
% RER equals nom ER + diff btn foreign inflation and dom. core inflation
figure ();
plot(plotRange, dbFcast.dl_z,...
'linewidth', 2);
hold on
plot(plotRange, dbFcast.dl_z_tnd,...
'linewidth', 2);
% plot(plotRange, dbFcast.l_z_gap,...
% 'linewidth', 2);
zeroline
grid on
highlight(HighRange); %,'EdgeColor','m','LineWidth',1.5);
legend ('RER, ann. QQ %','RER trend, ann. QQ %', 'gap''interpreter', 'none','Fontsize',10);
title('Real exchange rate : Growth vs. Trend','interpreter', 'none','FontSize',12);
exportgraphics(gcf, 'graphs/RER_yoy.emf');
%=======================================================================================================================================================================================================================
...
'linewidth', 2);
%'color', 'k'),...
legend ('Nom. IB rate', 'IB rate trend', 'interpreter', 'none','Fontsize',12,...
'location', 'southoutside',...
  'orientation', 'horizontal');
zeroline
grid on
highlight(HighRange) %,'EdgeColor','m','LineWidth',1.5);
title('Policy rate (IB rate), and trend (neutral), %', 'FontSize',12); %,'interpreter', 'none');
exportgraphics(gcf, 'graphs/IB_rate_trend.emf');
%===========================================================================================================================================================================================================================
%% IB rate (i) decomposition
i_decomp = dbDecomp.i;
figure ();
...
'linewidth', 2);
%'color', 'k');
legend ('IB rate', 'Exp.CPI_core{+1}','RIR (IB)', 'interpreter', 'none','Fontsize',12,...
'location', 'southoutside',...
  'orientation', 'horizontal');
zeroline
grid on
...
title('Interbank (IB) rate, Exp.CPI_core{+1} and RIR, %', 'FontSize',12,...
    'interpreter', 'none');
exportgraphics(gcf, 'graphs/RIR components.emf');
%==================================================================================================================================================================
...
exportgraphics(gcf, 'graphs/real market int.rates.emf');
%================================================================================================================================================================================
