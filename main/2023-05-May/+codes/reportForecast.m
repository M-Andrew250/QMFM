...
varNames   = [
  "debt_fcy", "Debt in foreign currency"
  "debt_lcy",   "Debt in local currency"
  "tb_rat",    "Resource balance ratio % GDP";
  "dl_py",      "Pct change deflator"
  "dBP_usd",    "Capital flows in USD"
...
rprt = codes.reporting.addDecompCharts(opts, rprt, m, dbDecomp, optsFR.plotRange, legends);
