...
% load data
tmp = load('results\mat\data.mat');
db = tmp.dbObsTrans;

% load model
tmp = load('results\mat\model.mat');
m = tmp.m;

% load forecast results
tmp = load('results\mat\forecast.mat');
dbFcast = tmp.dbFcast;
...
%to the forecast uncertainty of each model variable. we do insert variabe for which we
