...
CovRange = qq(2019, 4) : qq(2020,4);
PCovRange = qq(2021,1) : qq(2021,4);
UkWRange = qq(2022,1) : qq(2023,4);
...
legend ('Consumption','Investment','Govt demand', ...
  ...
  'interpreter', 'none');
grid on
highlight(CovRange,'FaceColor','r', 'FaceAlpha', 0.2);
highlight(PCovRange,'FaceColor','k', 'FaceAlpha', 0.2);
highlight(UkWRange,'FaceColor','r', 'FaceAlpha', 0.2);
text(1770, -23, 'COVID-19', 'FontSize', 8, 'FontWeight','bold')
text(2170, -23, {'Post', 'COVID-19'}, 'FontSize', 8, 'FontWeight','bold')
text(2650, -23, {'Russia-Ukraine', 'War'}, 'FontSize', 8, 'FontWeight','bold')
...
highlight(PCovRange,'FaceColor','k', 'FaceAlpha', 0.2);
highlight(UkWRange,'FaceColor','r', 'FaceAlpha', 0.2);
text(1770, 12, 'COVID-19', 'FontSize', 8, 'FontWeight','bold')
text(2170, 12, {'Post', 'COVID-19'}, 'FontSize', 8, 'FontWeight','bold')
text(2650, -3, {'Russia-Ukraine', 'War'}, 'FontSize', 8, 'FontWeight','bold')
...
highlight(PCovRange,'FaceColor','k', 'FaceAlpha', 0.2);
highlight(UkWRange,'FaceColor','r', 'FaceAlpha', 0.2);
text(1770, -25, 'COVID-19', 'FontSize', 8, 'FontWeight','bold')
text(2170, -25, {'Post', 'COVID-19'}, 'FontSize', 8, 'FontWeight','bold')
text(2650, -25, {'Russia-Ukraine', 'War'}, 'FontSize', 8, 'FontWeight','bold')
...
%%
figure("visible", "on")
plot(plotRange, db.e_dl_cpi_core, 'linewidth', 2);
zeroline;
grid on
highlight(HighRange);
legend('Expected Core Inflation');
