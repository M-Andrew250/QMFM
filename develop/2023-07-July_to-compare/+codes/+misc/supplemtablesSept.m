...
dc.gdem_a = convert(gdem_y,'a', 'method', 'last')*100; %ak corr *100 Oct 16 2023
% govt savings (domestic, before ext. grants)
dc.gsavdom_a = dc.grev_a - 0.55*dc.gdem_a - dc.oexp_a; % assume 45% gdem is investment
...
% savings and investment, % nominal GDP (AK Oct 16 2023)
dc.psavdom_a = 1- dc.cons_y_nom_a - dc.grev_a + dc.oexp_a; % govt oexp: transfers, interest (error: for.interest)
dc.totsavdom_a  = dc.psavdom_a + dc.gsavdom_a; % private: /nomGDP, govt: /realGDP
dc.totinv_a  = dc.inv_y_nom_a + 0.55*dc.gdem_a; % private: /nomGDP, govt: /realGDP
...
dc.debt_y_a = convert(db.debt_y/4,'a', 'method', 'last'); % ak Oct 12 2023: divide by 4
...
if codes.utils.checkFile(fileName)
