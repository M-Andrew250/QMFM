...
% Load the historical tunes database
dbTunes = codes.utils.readTunes(opts, "Baseline", m);

% Combine tunes and observations
dbObs = dboverlay(dbObs, dbTunes);
...
codes.utils.saveResult(opts, "filter", "dbObs", "dbTunes", "dbFilt", "dbShockDecomp", "dbEqDecomp")
