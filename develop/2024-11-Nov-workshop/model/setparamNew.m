...
% --- Core inflation --- 
p.b1  = 0.35; % lag,  before 0.35; IMF WP/20/295 has 0.5, but must be tested
...
p.c1 = 0.8; % Smoothing, was 0.5, now close to NBR 0.8 & other references
p.c2 = 1.2; % dl_cpi_dev, lower end of the reference range, but larger then IMF WP/20/295
p.c3 = 0.2; % l_y_gap, most references have similar value, but NBR-IMF WP/20/295 has lower (0.2)
...
p.e1 = 0.5; % we had 0.5 before (pure target 0, pure UIP 1)
p.e2 = 0.5;   % Forward looking: 1
p.e3 = 0.9;   % Premium AR
