...
opts.roundId        = "2024 Sept development round";
opts.modelFile      = "minecofin";
opts.mainDataFile   = "2024-09-07"; % name of data/Rwametric file 
opts.addDataFile    = "2024-09-01"; % unchanged GTM file (real interest), old file name
...
% Filtered range
opts.filterHistory.range = qq(2006,1) : qq(2024,3); % default 2024Q1 if data; extend filter for shocktuning +2Q
...
opts.forecastReport.highlightRange = qq(2015,1) : qq(2024,1); %  

% Range of the tables in the forecast report
opts.forecastReport.tableRange = qq(2022,4) : qq(2028,4); % extend 2028Q4
